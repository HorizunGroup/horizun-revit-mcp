  ...
  ""properties"": {
    ...
    ""operations"": { ""type"": ""array"", ""minItems"": 1, ""maxItems"": 500, ""items"": {
      ""type"": ""object"", ""required"": [""operation"", ""element_ids""], ""properties"": {
        ""operation"": { ""type"": ""string"", ""enum"": [""wall_join"", ""move"", ""copy"", ""rotate"", ""mirror"", ""pin"", ""unpin"", ""change_type"", ""change_type_by_rule"", ""realign_wall_sketch"", ""set_curve"", ""move_tag_head"", ""set_tag_leader"", ""array_linear"", ""array_radial""],
