...
namespace Horizun.Revit.Core
{
    ...
    public static class CadDwgScript
    {
        ...
        public static readonly string[] Forms =
        {
            ...
            @"(defun hz-attdef (f base ed) (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-n 40 ed) ""\t"" (hz-n 50 ed) ""\t"" (hz-str 2 ed) ""\t"" (hz-str 1 ed)) f))",
            @"(defun hz-entity (f owner ed / typ h lay base) (setq typ (cdr (assoc 0 ed)) h (cdr (assoc 5 ed)) lay (cdr (assoc 8 ed))) (setq base (strcat ""E\t"" owner ""\t"" (if h h """") ""\t"" typ ""\t"" (hz-esc (if lay lay """")) ""\t"")) (cond ((= typ ""TEXT"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-n 40 ed) ""\t"" (hz-n 50 ed) ""\t"" (hz-str 1 ed)) f)) ((= typ ""MTEXT"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-n 40 ed) ""\t"" (hz-n 50 ed) ""\t"" (hz-str 1 ed)) f)) ((= typ ""ATTDEF"") (hz-attdef f base ed)) ((= typ ""INSERT"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-n 50 ed) ""\t"" (hz-n 41 ed) ""\t"" (hz-n 42 ed) ""\t"" (hz-n 43 ed) ""\t"" (hz-str 2 ed) ""\t"" (hz-dyn-fields ed)) f)) ((= typ ""LINE"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-pt (cdr (assoc 11 ed)))) f)) ((= typ ""CIRCLE"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-n 40 ed)) f)) ((= typ ""ARC"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed))) ""\t"" (hz-n 40 ed) ""\t"" (hz-n 50 ed) ""\t"" (hz-n 51 ed)) f)) ((= typ ""LWPOLYLINE"") (write-line (strcat base (hz-n 90 ed) ""\t"" (hz-n 70 ed) ""\t"" (hz-lwpts ed)) f)) ((= typ ""LEADER"") (write-line (strcat base (hz-lwpts ed)) f)) ((= typ ""HATCH"") (write-line (strcat base (hz-str 2 ed) ""\t"" (hz-n 70 ed) ""\t"" (hz-n 91 ed) ""\t"" (hz-hatch ed)) f)) ((= typ ""VERTEX"") (write-line (strcat base (hz-pt (cdr (assoc 10 ed)))) f)) ((= typ ""ATTRIB"") (write-line (strcat ""A\t"" owner ""\t"" (hz-str 2 ed) ""\t"" (hz-str 1 ed)) f)) (T (write-line base f))))",
