...
namespace Horizun.Revit.Commands
{
    public sealed class ManageCurtainCommand : ICommand
    {
        ...
        private static ModelEdit Plan(Document doc, JObject r, double scale)
        {
        ...
        private static void PlanAddLine(Document doc, JObject r, double scale, Element host, long hostId, int gridIndex, ModelEdit edit)
        {
        ...
        private static void PlanRemoveLine(Document doc, JObject r, long hostId, int gridIndex, CurtainGrid grid, ModelEdit edit)
        {
        ...
        private static void PlanMullions(Document doc, JObject r, long hostId, int gridIndex, CurtainGrid grid, ModelEdit edit)
        {
            long lineId = r.Value<long>("grid_line_id");
            CurtainGridLine gl = LineOf(doc, grid, lineId);
        ...
        private static void PlanPanels(Document doc, JObject r, double scale, long hostId, int gridIndex, CurtainGrid grid, ModelEdit edit)
        {
