...
# Get-HorizunTunnelClient moved to chatgpt-tunnel.lib.ps1, which reads the client's
# variant and capabilities from its own answers (exit codes kept, never its file name).
