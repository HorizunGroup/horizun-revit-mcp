...
$thirdPartyDllLicences = @{
    ...
    'Mono.Unix.dll'                      = 'MIT'
    'Microsoft.Bcl.HashCode.dll'         = 'MIT'
    'UglyToad.PdfPig.Core.dll'           = 'Apache-2.0'
    'UglyToad.PdfPig.dll'                = 'Apache-2.0'
    'UglyToad.PdfPig.DocumentLayoutAnalysis.dll' = 'Apache-2.0'
    'UglyToad.PdfPig.Fonts.dll'          = 'Apache-2.0'
    'UglyToad.PdfPig.Package.dll'        = 'Apache-2.0'
    'UglyToad.PdfPig.Tokenization.dll'   = 'Apache-2.0'
    'UglyToad.PdfPig.Tokens.dll'         = 'Apache-2.0'
